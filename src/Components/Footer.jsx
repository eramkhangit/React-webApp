...
export default function Footer() {
  return (
    <div className='max-w-[1240px] bg-[#04b913] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-white'>
      <div>
        <h1 className='w-full text-3xl font-bold text-black'>XYZ Tech Hub</h1>
